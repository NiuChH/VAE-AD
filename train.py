...
# ## put model to train ## (The two models are trained as a separate module so that it would be easy to use as an
# independent module in different scenarios)
model.train()
G_estimate.train()

# Optimiser Declaration
Optimiser = Adam(list(model.parameters()) + list(G_estimate.parameters()), lr=args["learning_rate"],
                 weight_decay=0.0001)
